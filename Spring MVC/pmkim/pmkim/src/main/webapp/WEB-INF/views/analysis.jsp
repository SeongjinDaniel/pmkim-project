...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"
	import="java.util.List, java.util.ArrayList, vo.GoodsInfoThemeVO"%>
<!DOCTYPE html>
<html lang="en">
<!-- Basic -->
			...
			<div class="container">
				...
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="index.html"><img
						src="/pmkim/resources/images/logo.png" class="logo" alt=""></a>
				</div>
					...
					<div id="carousel-example-1"
						...
						<div class="carousel-inner" role="listbox">
							<div class="carousel-item active">
								<img class="d-block w-100" src="/pmkim/resources/images/cu.png"
									alt="First slide">
							</div>
							...
							<div class="carousel-item">
								<img class="d-block w-100"
									src="/pmkim/resources/images/emart24.png" alt="Third slide">
							</div>
							<div class="carousel-item">
								<img class="d-block w-100"
									src="/pmkim/resources/images/seveneleven.png"
									alt="Fourth slide">
							</div>
							<div class="carousel-item">
								<img class="d-block w-100"
									src="/pmkim/resources/images/mini.png" alt="Fifth slide">
							</div>
						</div>
						...
						<ol class="carousel-indicators">
							<li data-target="#carousel-example-1" data-slide-to="0"
								...
								src="/pmkim/resources/images/cu_2.png" alt="" /></li>
							<li data-target="#carousel-example-1" data-slide-to="1"><img
								class="d-block w-100 img-fluid"
								src="/pmkim/resources/images/gs25_2.png" alt="" /></li>
							<li data-target="#carousel-example-1" data-slide-to="2"><img
								class="d-block w-100 img-fluid"
								src="/pmkim/resources/images/emart24_2.png" alt="" /></li>
							<li data-target="#carousel-example-1" data-slide-to="2"><img
								class="d-block w-100 img-fluid"
								src="/pmkim/resources/images/seveneleven_2.png" alt="" /></li>
							<li data-target="#carousel-example-1" data-slide-to="2"><img
								class="d-block w-100 img-fluid"
								src="/pmkim/resources/images/mini_2.png" alt="" /></li>
						</ol>
					</div>
				</div>
				...
				<div class="col-lg-12">
					...
					<div class="featured-products-box owl-carousel owl-theme">
						<div class="item">
							<div class="products-single fix">
								<div class="box-img-hover">
									<img src="/pmkim/resources/images/img-pro-01.jpg"
						...
						<div class="item">
							<div class="products-single fix">
								<div class="box-img-hover">
									<img src="/pmkim/resources/images/img-pro-02.jpg"
										class="img-fluid" alt="Image">
									<div class="mask-icon">
										<ul>
											<li><a href="#" data-toggle="tooltip"
						...
						<div class="item">
							<div class="products-single fix">
								<div class="box-img-hover">
									<img src="/pmkim/resources/images/img-pro-03.jpg"
										class="img-fluid" alt="Image">
									<div class="mask-icon">
										<ul>
											<li><a href="#" data-toggle="tooltip"
						...
						<div class="item">
							<div class="products-single fix">
								<div class="box-img-hover">
									<img src="/pmkim/resources/images/img-pro-04.jpg"
										class="img-fluid" alt="Image">
									<div class="mask-icon">
										<ul>
											<li><a href="#" data-toggle="tooltip"
