...
<body>
	<div class="w3-content w3-container w3-margin-top">
		<div class="w3-container w3-card-4">
			...
			<div>
				<form id="joinForm" action="/pmkim/member/join_member" method="post">
					<p>
						<label>ID</label> 
					...
					<p>회원 유형 : 
					<input type = "radio" name = "member_type" value = "owner">OWNER
        			<input type = "radio" name = "member_type" value = "customer">CUSTOMER
					</p>
					<p class="w3-center">
